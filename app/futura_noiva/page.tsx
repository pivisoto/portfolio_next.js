      ...
      <AnimatePresence mode="wait">
        {!acessoLiberado ? (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="flex flex-col items-center gap-6 p-10 bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl border border-zinc-100 dark:border-zinc-800"
          >
            ...
            <form onSubmit={verificarSenha} className="flex flex-col gap-4 w-full">
              <input
                ...
                className="px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 dark:bg-zinc-800 dark:text-white dark:border-zinc-700"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-red-500 text-white rounded-xl font-bold hover:bg-red-600 transition-all active:scale-95"
              >
                Desbloquear ❤️
              </button>
            </form>
          ...
          <motion.main
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex min-h-screen w-full max-w-4xl flex-col items-center justify-center py-32 px-16 bg-white dark:bg-black sm:items-start"
          >
            <div className="flex flex-col items-center gap-12 text-center sm:items-start sm:text-left">
              ...
              <div className="flex flex-col gap-4">
                ...
                <ul className="max-w-2xl text-xl md:text-2xl leading-relaxed text-zinc-600 dark:text-zinc-400 list-disc list-inside">
                  <li>Linda</li>
                  <li>Gentil</li>
                  ...
                  <li>Inteligente</li>
                  <li>Gosto musical diferenciado</li>
                  <li>Prestativa</li>
                  <li>Cheirosa</li>
                  <li>Calma (se eu obedecer)</li>
                  <li>Irresistível</li>
                  <li>Interessante</li>
                  <li>Até que é boa na sinuca mas tem oque aprender</li>
                  <li>E mais um milhão de coisas que não cabem aqui ❤️</li>
                </ul>
              </div>

              <button
                onClick={() => setMostrarMensagem(!mostrarMensagem)}
                className="mt-8 px-8 py-4 bg-red-500 text-white rounded-full font-bold hover:bg-red-600 transition-all shadow-lg active:scale-95"
              >
              ...
              <AnimatePresence>
                {mostrarMensagem && (
                  <motion.div
                    ...
                    className="flex flex-col items-center mt-10 text-4xl md:text-5xl font-bold text-red-600 dark:text-red-400"
                  >
                    Eu te amo!
                    <svg
                      viewBox="0 0 24 24"
                      className="w-40 h-40 mt-6 text-red-500 fill-none stroke-current"
                      strokeWidth="0.5"
                    >
                      <motion.path
                        ...
                        transition={{
                          ...
                          fill: { duration: 1.2, delay: 2, ease: "easeIn" }
                        }}
                      />
                    </svg>
                  </motion.div>
